...
hA5_model=tf.keras.models.Model(input_layer,output_layer)
hA5_model.summary()

hA5_model.compile(loss='binary_crossentropy',optimizer='adam',metrics=['accuracy'])
history = hA5_model.fit(x_train,y_train,epochs=10,batch_size=32,validation_data=(x_develop,y_develop))
predict = hA5_model.predict(x_test)
print(predict)
